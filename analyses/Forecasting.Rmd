...
```
However, the conversions seem to be clustered in the middle of the dataset with multiple high-count observations so the model must have weighted the count evidence like that. We could model that with Gamma-Poisson or Negative Binomial model in future iterations of the model.
